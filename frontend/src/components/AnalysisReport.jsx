            ...
            <div style={styles.gridContainer}>
                ...
                {!isApproved && (
                    <div style={{...styles.card, gridColumn: 'span 12', backgroundColor: '#FFFBEA', border: '1px solid #FFD6A5', textAlign: 'center'}}>
                        ...
                        <p style={{margin: '0 0 1.5rem 0', fontSize: '0.9rem', color: '#B45309'}}>Approve to proceed to the Strategic Message step, or modify the brief to re-analyze.</p>
