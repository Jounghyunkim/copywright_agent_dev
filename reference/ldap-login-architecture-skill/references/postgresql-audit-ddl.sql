-- PostgreSQL 14+ baseline for LDAP auth audit/statistics
...
CREATE TABLE IF NOT EXISTS auth_login_events (
  ...
  request_id TEXT,
  user_id TEXT NULL,
  username_input TEXT NOT NULL CHECK (LENGTH(TRIM(username_input)) > 0),
...
CREATE TABLE IF NOT EXISTS auth_session_events (
  ...
  event_type TEXT NOT NULL CHECK (event_type IN ('created', 'refreshed', 'revoked', 'expired', 'logout')),
  reason TEXT NULL,
  source_ip INET NULL,
  user_agent TEXT NULL
);
